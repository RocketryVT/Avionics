...
volatile TaskHandle_t serial_task_handle = NULL;
...
//TODO: This entire section needs to be moved to its corresponding file and documented
/****************************** KALMAN ****************************************/
...
int main() {
    ...
    */
    ...
    xTaskCreate(serial_task, "serial", 4096, NULL, SERIAL_TASK_PRIORITY, const_cast<TaskHandle_t *>(&serial_task_handle));
    vTaskCoreAffinitySet(serial_task_handle, 0x01);
...
static void scan_cmd_func() {
    //I2C Bus scan ripped from Pico SDK; pings all I2C addresses and returns found sensors
    printf("\nI2C Bus Scan\n");
...
//TODO: All of these method definitions should be moved
fix16_t calculate_drag_force(fix16_t deployment_percentage, fix16_t vertical_velocity) {
